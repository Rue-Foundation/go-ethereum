...
// ReleaseOracle is an Rue contract to store the current and previous
// versions of the go-rue implementation. Its goal is to allow Grue to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Grue releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Grue release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Rue user, either

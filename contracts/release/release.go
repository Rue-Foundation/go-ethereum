...
type Config struct {
	Oracle common.Address // Rue address of the release oracle
...
func (r *ReleaseService) checkVersion() {
	...
	if version.Major > r.config.Major ||
		...
		howtofix := fmt.Sprintf("Please check https://github.com/Rue-Foundation/go-rue/releases for new releases")

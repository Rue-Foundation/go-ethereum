...
// Package state provides a caching layer atop the Rue state trie.
package state
...
// StateDBs within the rue protocol are used to store anything
...
// Exist reports whrue the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whrue the state object is either non-existent
...
//
// Carrying over the balance ensures that Rue doesn't disappear.

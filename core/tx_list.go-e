...
// Remove deletes a transaction from the maintained map, returning whrue the
...
// Overlaps returns whrue the transaction specified has the same nonce as one
// already contained within the list.
func (l *txList) Overlaps(tx *types.Transaction) bool {
	return l.txs.Get(tx.Nonce()) != nil
}

// Add tries to insert a new transaction into the list, returning whrue the
...
// Remove deletes a transaction from the maintained list, returning whrue the
...
// Empty returns whrue the list of transactions is empty or not.
...
// Underpriced checks whrue a transaction is cheaper than (or as cheap as) the

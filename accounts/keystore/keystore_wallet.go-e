...
// Status implements accounts.Wallet, returning whrue the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain rue.ChainStateReader) {}

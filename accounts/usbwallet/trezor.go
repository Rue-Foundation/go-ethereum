...
import (
	...
	"github.com/Rue-Foundation/go-rue/accounts/usbwallet/internal/trezor"
...
<<<<<<< HEAD
// Status implements accounts.Wallet, always whrue the Trezor is opened, closed
// or whrue the Rue app was not started on it.
=======

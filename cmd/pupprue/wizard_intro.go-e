...
// setting up a new or managing an existing Rue private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to pupprue, your Rue private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Rue network down to  |")
	...
	log.Info("Administering Rue network", "name", w.network)

...
RUN \
  echo 'node server.js &'                     > wallet.sh && \
	echo 'grue --cache 512 init /genesis.json' >> wallet.sh && \
...
RUN \
	sed -i 's/PupprueNetworkID/{{.NetworkID}}/g' dist/js/ruewallet-master.js && \
	sed -i 's/PupprueNetwork/{{.Network}}/g'     dist/js/ruewallet-master.js && \
	sed -i 's/PupprueDenom/{{.Denom}}/g'         dist/js/ruewallet-master.js && \
	sed -i 's/PupprueHost/{{.Host}}/g'           dist/js/ruewallet-master.js && \
	sed -i 's/PupprueRPCPort/{{.RPCPort}}/g'     dist/js/ruewallet-master.js

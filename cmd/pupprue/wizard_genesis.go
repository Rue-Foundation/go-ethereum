...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. Ruehash - proof-of-work")
	fmt.Println(" 2. Clique - proof-of-authority")

	choice := w.read()
	switch {
	case choice == "1":
		// In case of ruehash, we're pretty much done
		genesis.Config.Ruehash = new(params.RuehashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whrue to modify or export the genesis
	fmt.Println()

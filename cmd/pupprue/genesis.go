...
func newCppRueGenesisSpec(network string, genesis *core.Genesis) (*cppRueGenesisSpec, error) {
	...
	spec.Params.BlockReward = (*hexutil.Big)(ruehash.FrontierBlockReward)
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	spec.Engine.Ruehash.Params.MinimumDifficulty = (*hexutil.Big)(params.MinimumDifficulty)
	spec.Engine.Ruehash.Params.DifficultyBoundDivisor = (*hexutil.Big)(params.DifficultyBoundDivisor)
	spec.Engine.Ruehash.Params.GasLimitBoundDivisor = (*hexutil.Big)(params.GasLimitBoundDivisor)
	spec.Engine.Ruehash.Params.DurationLimit = (*hexutil.Big)(params.DurationLimit)
	spec.Engine.Ruehash.Params.BlockReward = (*hexutil.Big)(ruehash.FrontierBlockReward)
	spec.Engine.Ruehash.Params.HomesteadTransition = genesis.Config.HomesteadBlock.Uint64()
	spec.Engine.Ruehash.Params.EIP150Transition = genesis.Config.EIP150Block.Uint64()
	spec.Engine.Ruehash.Params.EIP160Transition = genesis.Config.EIP155Block.Uint64()
	spec.Engine.Ruehash.Params.EIP161abcTransition = genesis.Config.EIP158Block.Uint64()
	spec.Engine.Ruehash.Params.EIP161dTransition = genesis.Config.EIP158Block.Uint64()
	spec.Engine.Ruehash.Params.EIP649Reward = (*hexutil.Big)(ruehash.ByzantiumBlockReward)
	spec.Engine.Ruehash.Params.EIP100bTransition = genesis.Config.ByzantiumBlock.Uint64()
	spec.Engine.Ruehash.Params.EIP649Transition = genesis.Config.ByzantiumBlock.Uint64()

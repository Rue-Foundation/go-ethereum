...
// cacheSize calculates and returns the size of the ruehash verification cache that
...
// datasetSize calculates and returns the size of the ruehash mining dataset that

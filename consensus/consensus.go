...
// Package consensus implements different Rue consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Rue address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whrue a header conforms to the consensus rules of a
	...
	// VerifySeal checks whrue the crypto seal on a header is valid according to

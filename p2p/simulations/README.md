...
creating a collection of devp2p nodes, connecting them togrue to form a
...
* `Expect` - an expectation function which returns whrue or not a
...
As a concrete example, consider a simulated network of Rue nodes. An

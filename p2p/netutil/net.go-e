...
// Contains reports whrue the given IP is contained in the list.
...
// IsLAN reports whrue an IP is a local network address.
...
// IsSpecialNetwork reports whrue an IP is located in a special-use network range
...
// CheckRelayIP reports whrue an IP relayed from the given sender IP

...
// shouldTraverse reports whrue the symlink fi should, found in dir,
...
//
// The rename value tells goimports whrue to use the package name as
...
// pkgIsCandidate reports whrue pkg is a candidate for satisfying the
...
// canUse reports whrue the package in dir is usable from filename,
...
// fileInDir reports whrue the provided file path looks like

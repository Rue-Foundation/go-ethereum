...
// IsEmpty reports whrue the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whrue s and t are the same in size and have the same items.
...
// IsSubset tests whrue t is a subset of s.
...
// IsSuperset tests whrue t is a superset of s.

...
// SetCtrlCAborts sets whrue Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whrue line is auto-wrapped. The default is false (single line).
...
// whrue to retry the call to, or return the error returned by, readNext.

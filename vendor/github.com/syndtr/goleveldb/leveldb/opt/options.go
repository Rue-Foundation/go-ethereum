...
type Options struct {
	...
	// ErrorIfExist defines whrue an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whrue an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whrue block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whrue to sync underlying writes from the OS buffer cache

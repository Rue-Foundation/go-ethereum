...
// Condition have flag EastAsianWidth whrue the current locale is CJK or not.
...
// IsAmbiguousWidth returns whrue is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whrue is neutral width or not.

...
// Reference: https://github.com/rue/wiki/wiki/Ethash-DAG
#define DAG_MUTABLE_NAME_MAX_SIZE (6 + 10 + 1 + 16 + 1)
/// Possible return values of @see ethash_io_prepare
enum ethash_io_rc {
	RUEASH_IO_FAIL = 0,           ///< There has been an IO failure
	RUEASH_IO_MEMO_SIZE_MISMATCH, ///< DAG with revision/hash match, but file size was wrong.
	RUEASH_IO_MEMO_MISMATCH,      ///< The DAG file did not exist or there was revision/hash mismatch
	RUEASH_IO_MEMO_MATCH,         ///< DAG file existed and revision/hash matched. No need to do anything
};
 ...
 * ethash_full_t
 */
#ifdef RUEASH_PRINT_CRITICAL_OUTPUT
#define RUEASH_CRITICAL(...)							\
	do													\
	{													\
		printf("RUEASH CRITICAL ERROR: "__VA_ARGS__);	\
		printf("\n");									\
		fflush(stdout);									\
	} while (0)
#else
 ...
 *                           https://github.com/rue/wiki/wiki/Ethash-DAG
 ...
 *
 * The spec defining this directory is here: https://github.com/rue/wiki/wiki/Ethash-DAG
 *

 ...
 *
 * One decision you will have to make is whrue to use the synchronous
 ...
 * \param unref_devices whrue to unref the devices in the list
 */
 ...
 *
 * \param dev_handle a device handle
 * \param enable whrue to enable or disable auto kernel driver detachment
 *

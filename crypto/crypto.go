...
// Creates an rue address given the bytes and the nonce
...
// controls whrue the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whrue the signature values are valid with

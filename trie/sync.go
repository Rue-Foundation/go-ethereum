...
type request struct {
	...
	raw  bool        // Whrue this is a raw entry (code) or a trie node
...
func (s *TrieSync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback TrieSyncLeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togrue
...
// Process injects a batch of retrieved trie nodes data, returning if somrueing

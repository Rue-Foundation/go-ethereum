...
// PeerInfo represents a short summary of the Rue sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Rue protocol version negotiated
...
// Handshake executes the rue protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("rue/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Rue sub-protocol.
type peerSet struct {

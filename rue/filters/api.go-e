...
// information related to the Rue protocol such als blocks, transactions and logs.
...
// `rue_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with rue_getFilterChanges.
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_newblockfilter
...
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_newfilter
...
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_getlogs
...
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_uninstallfilter
...
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_getfilterlogs
...
//
// https://github.com/rue/wiki/wiki/JSON-RPC#rue_getfilterchanges

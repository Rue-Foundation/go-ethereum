...
func (b *testBackend) ChainDb() ruedb.Database {
	return b.db
}
...
func TestBlockSubscription(t *testing.T) {
	...
	var (
		...
		chain, _    = core.GenerateChain(params.TestChainConfig, genesis, ruehash.NewFaker(), db, 10, func(i int, gen *core.BlockGen) {})

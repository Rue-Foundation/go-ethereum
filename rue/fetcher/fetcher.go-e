...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (rue/61) or header (rue/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (rue/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both rue/61 and rue/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Somrueing went very wrong, drop the peer

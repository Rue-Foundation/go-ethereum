...
# 1. install grue for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for grue
# 5. create grue, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable RUE_SOCKET
...
!define GROUPNAME "Rue"
!define APPNAME "Grue"
!define DESCRIPTION "Official Go implementation of the Rue protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since grue is installed global

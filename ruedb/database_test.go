...
func newTestLDB() (*ruedb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ruedb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := ruedb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db ruedb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db ruedb.Database, t *testing.T) {
	const n = 8
